    ...
    if request.method == "POST":
        ...
        if p_item_object:
            if current_user.can_purchase(p_item_object):
                ...
                flash(f"Compraste {p_item_object.name}. ", category='success')
            else:
                flash(
                    f"No tienes suficiente dinero para comprar {p_item_object.name}. ",
                    category='danger')
        ...
        if s_item_object:
            if current_user.can_sell(s_item_object):
                ...
                flash(f"Devolviste {s_item_object.name} al mercado",
                      category='success')
            else:
                flash(f"Algo salio mal vendiendo {s_item_object.name}",
                      category='danger')
